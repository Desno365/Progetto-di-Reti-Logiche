...
architecture projectArch of project_reti_logiche is
    ...
    end get_next_state_and_address;
    ...
    begin
        case current_state is
            ...
            when S_INPUT_MASK =>
                if(input_mask_signal = "00000000") then
                    next_state <= S_C8Y; -- va direttamente alla scrittura del dato di uscita
                    o_address <= "----------------";
                else
                    next_state <= S_COORD_X;
                    o_address <= std_logic_vector(START_ADDRESS + 17); -- 17 X del punto da valutareo_address <= std_logic_vector(START_ADDRESS + 17); -- 17 X del punto da valutare
                end if;
            ...
            when S_COORD_Y =>
                get_next_state_and_address(0, input_mask_signal, next_state, o_address);
            ...
            when S_C1Y =>
                get_next_state_and_address(1, input_mask_signal, next_state, o_address);
            ...
            when S_C2Y =>
                get_next_state_and_address(2, input_mask_signal, next_state, o_address);
            ...
            when S_C3Y =>
                get_next_state_and_address(3, input_mask_signal, next_state, o_address);
            ...
            when S_C4Y =>
                get_next_state_and_address(4, input_mask_signal, next_state, o_address);
            ...
            when S_C5Y =>
                get_next_state_and_address(5, input_mask_signal, next_state, o_address);
            ...
            when S_C6Y =>
                get_next_state_and_address(6, input_mask_signal, next_state, o_address);
            ...
            when S_C7Y =>
                get_next_state_and_address(7, input_mask_signal, next_state, o_address);
